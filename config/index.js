export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxfcee00afa495310f",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "89003fc0029b98c27d4a660b49b1d5ac",
  ...
  USERS: [
    {
      ...
      id: "ow8Hp6aU-vwvyphStdAi67eaQpKc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "IwXVcuJkoCGr_JBxN8OOHB5dvZJpXFcjDVAdTzX9cSk",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "北海",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-08-10"},
      ]
    },
    {
      name: "老婆1",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ow8Hp6eBPZgk-KsToWzhvlLKcTD8",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
